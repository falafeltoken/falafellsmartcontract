...
//Website: https://www.FalafelToken.com
...
contract Falafel is Context, IBEP20, Ownable {
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        _MAX_TX_SIZE = _tTotal.mul(maxTxPercent).div(100);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        // Remove fees for transfers to and from excluded account
        bool takeFee = true;
